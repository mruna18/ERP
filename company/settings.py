...
# Env-based config: set SECRET_KEY, DEBUG, ALLOWED_HOSTS in environment or .env (e.g. python-dotenv)
SECRET_KEY = os.environ.get('SECRET_KEY')
if not SECRET_KEY:
    # Dev fallback only — in production always set SECRET_KEY in the environment
